...
const Form = ({flag}) => {
    return (
        <>
            <div className=" bg-white w-[80%] h-[90%] m-auto rounded-[4vw] ">
            

                <div className=" max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-lg">
                        <h1 className="text-center text-2xl font-bold text-black sm:text-3xl"><Link to="/">Noon</Link></h1>
                        ...
                        <form action="#" className="mt-6 mb-0 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                            <p className="text-center text-lg font-medium">{ flag?"Sign up":"Sign in"} to your account</p>
                            {
                            flag?<div>
                            ...
                            <p className="text-center text-sm text-gray-500">
                                No account?
                                <a className="underline" href={flag?"/login":"/signup"}>{ flag?"Sign in":"Sign up"}</a>
                            </p>
                        </form>
                    </div>
                </div>
